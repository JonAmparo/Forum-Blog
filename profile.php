...
<?php }?>
      ...
      <div id="content">
        ...
        <div id="contact_form">
         ...
         <form id="edit_Form" class="content" action="editSave_validation.php" method="POST" enctype="multipart/form-data">

          <div>
            <label   class="align">Gender:</label>
            <label><input type="radio" name="gender" <?php  if($x_gender=="Male" ) {echo "checked";}?> value="Male" > Male

            </label>
            <label>             
              <input type="radio" name="gender"  <?php  if($x_gender=="Female" )  {echo "checked";}?> value="Female"> Female
            </label>
          </div>
          ...
          <input style="margin-left: 100px;" type="submit" name="update_profile" class="submit_btn" value="Edit & Save">
          <a class='iframe  submit_btn' href="changepassword_form.php" style="color: white; text-decoration: none;">Change Password</a>
        </form>
